...
namespace Common.Helpers
{
    public static class ErrorLogger
    {
        ...
        public static void LogException(Exception error, HttpRequest request = null)
        {
            try
            {
...
{1}            
                    ...
                    ".FormatWith(exceptionMessage, error.ToString(), lineNumber, fileName, exceptionName, rawUrl, assemblyName, controllerName, actionName, urlReferrer);
