...
namespace ExigoService
{
    public class Customer : ICustomer
    {
        ...
        [Required, Remote("IsLoginNameAvailable", "App", ErrorMessage = "This username isn't available - try another one."), RegularExpression(GlobalSettings.RegularExpressions.LoginName, ErrorMessage = "Make sure your username doesn't contain any spaces or special characters."), Display(Name = "Username")]
        public string LoginName { get; set; }

        [Required, RegularExpression(GlobalSettings.RegularExpressions.Password, ErrorMessage = "Make sure your password isn't more than 50 characters long."), Display(Name = "Password"), DataType("NewPassword")]
