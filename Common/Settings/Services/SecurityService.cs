...
namespace Common.Services
{
    ...
    public class Security
    {
        ...
        public static string IdentityEncrypt(object plainText, int customerID)
        {
            ...
            return HttpContext.Current.Server.UrlEncode(Encrypt(plainText.ToString(), customerID.ToString(), GlobalSettings.Encryptions.General.IV));
        }
        ...
        {
            return Decrypt(HttpContext.Current.Server.UrlDecode(encryptedText), customerID.ToString(), GlobalSettings.Encryptions.General.IV);
        }
