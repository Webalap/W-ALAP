...
namespace ExigoService
{
    public static partial class Exigo
    {
        ...
        public static void CreateDefaultCalendarSubscriptions(int customerID)
        {
            ...
            //    })
            //    .FirstOrDefault();
            var enroller = Exigo.GetCustomer(customerID);
        ...
        private static void ClearCache(string cacheKey, int customerID)
        {
            if (HttpContext.Current != null)
            {
                HttpContext.Current.Cache.Remove(cacheKey + "_" + customerID);
            }
        }
        ...
        public static IEnumerable<ExigoService.Calendar> GetCustomerCalendarSubscriptions(int customerID)
        {
            ...
            //}
            yield return new ExigoService.Calendar();
        }
