...
namespace ExigoService
{
    ...
    public class ShoppingCartItemCollection : List<ShoppingCartItem>, IShoppingCartItemCollection {
        ...
        public void Add(IShoppingCartItem item)
        {
            ...
            var newItem = ShoppingCartItem.Create( item );          
        ...
        public void Update(IShoppingCartItem item)
        {
            ...
            var cartitem = ShoppingCartItem.Create( item );
        ...
        public void Remove(string itemcode)
        {
            ...
            var matchingItems = this.Where(item => item.ItemCode.Equals(itemcode)).ToList();
            foreach (var item in matchingItems)
            {
                Remove(item);
            }
        ...
        {
            return this.ToList().Select(item => item.ToProduct());
        }
    }
