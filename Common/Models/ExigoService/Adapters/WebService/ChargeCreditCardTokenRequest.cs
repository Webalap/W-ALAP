...
namespace Common.Api.ExigoWebService
{
    public partial class ChargeCreditCardTokenRequest
    {
        ...
        public ChargeCreditCardTokenRequest(CreditCard card)
        {
            ...
            // It should store Address1 and Address2 Seprately
            BillingAddress  = card.BillingAddress.Address1;
            BillingAddress2 = card.BillingAddress.Address2;
            ...
            CreditCardType  = (int)card.TypeOfCard;
        }
