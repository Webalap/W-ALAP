...
namespace Common.Api.ExigoWebService
{
    ...
    public partial class CustomerResponse {
        ...
        public static explicit operator Customer( CustomerResponse customer ) {
            ...
            model.HighestAchievedRank   = new Rank() { RankID = customer.RankID, RankDescription = customer.RankID.ToString() };
