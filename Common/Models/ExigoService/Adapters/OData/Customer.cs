...
using ExigoCustomerStatus = ExigoService.CustomerStatus;
using ExigoCustomerType = ExigoService.CustomerType;
using ExigoRank = ExigoService.Rank;
...
namespace Common.Api.ExigoOData
{
    ...
    public partial class Customer {
        ...
        public static explicit operator ExigoCustomer( ODataCustomer customer ) {

            var model = new ExigoCustomer();
            ...
            if ( customer.CustomerType != null ) model.CustomerType = (ExigoCustomerType)customer.CustomerType;


            model.CustomerStatusID = customer.CustomerStatusID;

            if ( customer.CustomerStatus != null ) model.CustomerStatus = (ExigoCustomerStatus)customer.CustomerStatus;
            ...
            model.MailingAddress = new Address {
            ...
            model.OtherAddress = new Address {
                AddressType   = AddressType.Other,
            ...
            model.HighestAchievedRankId     = customer.RankID;
            model.HighestAchievedRank       = (ExigoRank)customer.Rank;
            ...
            if ( customer.Enroller != null ) {
                ...
                model.Enroller = (ExigoCustomer)customer.Enroller;

            }

            if ( customer.Sponsor != null ) {

                model.Sponsor = (ExigoCustomer)customer.Sponsor;
