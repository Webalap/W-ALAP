...
namespace Common.Api.ExigoOData
{
    public partial class Item
    {
        public static explicit operator ExigoService.Item(Item item)
        {
            ...
            model.TinyImageUrl               = GlobalUtilities.GetProductImagePath(item.TinyImageUrl, item.ItemCode);
            model.SmallImageUrl              = GlobalUtilities.GetProductImagePath(item.SmallImageUrl, item.ItemCode);
            model.LargeImageUrl              = GlobalUtilities.GetProductImagePath(item.LargeImageUrl, item.ItemCode);
