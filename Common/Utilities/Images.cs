...
namespace Common
{
    public static partial class GlobalUtilities
    {
        ...
        public static string GetCustomerAvatarUrl(int customerID, AvatarType type = AvatarType.Default, bool cache = true)
        {
            ...
            //}
            ////return "http://api.exigo.com/4.0/IndiaHicks/images/customers/" + customerID + "/avatar.png";
            //return "https://api.exigo.com/4.0/{0}/images/customers/{1}/{2}.png{3}".FormatWith(GlobalSettings.Exigo.Api.CompanyKey, customerID, filename, cachekey);

            return "/profiles/avatar/{0}/{1}/{2}".FormatWith(customerID, type, cache);
        }
        ...
        //    return "https://api.exigo.com/4.0/{0}/images/customers/{1}/avatar-raw.png{2}".FormatWith(GlobalSettings.Exigo.Api.CompanyKey, customerID, cachekey);
        //}
        ...
        public static string GetGravatarUrl(string email, int size = 50)
        {
            ...
            {
                return "https://placehold.it/{0}x{0}".FormatWith(size);
            }
        ...
        public static bool AvatarExists(int customerID)
        {
            using (var conn = new SqlConnection(GlobalSettings.Exigo.Api.Sql.ConnectionStrings.GetConnectionString()))
            {
                conn.Open();
